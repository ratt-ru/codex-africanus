...
def _residual_vis_wrapper(time_bin_indices, time_bin_counts, antenna1,
    ...
    return np_residual_vis(time_bin_indices, time_bin_counts, antenna1,
                           antenna2, jones[0][0], vis, flag, model[0], mode)
