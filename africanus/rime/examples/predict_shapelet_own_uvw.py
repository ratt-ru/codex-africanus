...
def predict(args):
    ...
    for xds in xds_from_ms(args.ms,
        ...
        plt.colorbar()
        plt.title("Shapelets_Own_UVW")
       # plt.show()
        plt.savefig("shapelets_own_uvw.png")
        plt.close()
...
#casalite casa browser
        ...
        plt.colorbar()
        plt.title("phase_shapelet_einsum_own_UVW")
        #plt.show()
        plt.savefig("phase_shapelet_einsum_own_uvw.png")
        plt.close()
        """
        ...
        plt.title("Phase_own_UVW")
        plt.colorbar()
        #plt.show()
        plt.savefig("jones_own_uvw.png")
        plt.close()
        """
        ...
        plt.colorbar()
        plt.title("Predict_Image_Own_UVW")
        plt.savefig("./predict_img_own_uvw.png")
        plt.close()
        """
