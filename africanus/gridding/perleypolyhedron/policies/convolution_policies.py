...
def convolve_1d_axisymmetric_packed(scaled_u, scaled_v, scaled_w,
                                    npix,
                                    grid,
                                    vis,
                                    r,c,
                                    ...
                                    policy_type):
    '''
    Convolution policy for a 1D axisymmetric packed AA kernel
    ...
    disc_u = int(np.floor(offset_u))
    disc_v = int(np.floor(offset_v))
...
def policy_impl(scaled_u, scaled_v, scaled_w,
                ...
                stokes_conversion_policy,
                policy_type):
    if policy_type.literal_value == "conv_1d_axisymmetric_packed":
        return convolve_1d_axisymmetric_packed
    else:
