...
for bl in range(ubl.shape[0]):
    ...
    for t in range(utime.shape[0]):
        ...
        elif timestamps[r] + half_int - bin_low > time_bin_secs:
            print("time_bin_secs is less", time_bin_secs, (timestamps[r] + half_int - bin_low))
            print("timestapms[r]", timestamps[r], "half_int", half_int,"bin_low", bin_low, "time_bin_secs",time_bin_secs)
...
# How Do I use time_lookup and bin_lookup to find original values ? 
